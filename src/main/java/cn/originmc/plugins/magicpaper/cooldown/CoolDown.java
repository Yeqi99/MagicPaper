...
public class CoolDown {
    ...
    public CoolDown(String id,long startTime, long duration, float reduction, long fixedReduction) {
        this.id = id;
    ...
    public CoolDown(String id, long duration, float reduction, long fixedReduction) {
        this.id = id;
