...
public class PlayerPointsHasFunction extends NormalFunction {
    @Override
    public FunctionResult whenFunctionCalled(SpellContext spellContext, List<FunctionResult> args) {
        if (args.size() < 2) {
            return new ErrorResult("FUNCTION_ARGS_ERROR", "PlayerPointsHas don't have enough args.");
        }
        ...
        return new BooleanResult(PlayerPointsManager.hasPoints(player.getUniqueId(), Integer.parseInt(money)));
    }
