...
public class VaultGiveFunction extends NormalFunction {
    @Override
    public FunctionResult whenFunctionCalled(SpellContext spellContext, List<FunctionResult> args) {
        if (args.size()<2){
            return new ErrorResult("FUNCTION_ARGS_ERROR", "VaultGive don't have enough args.");
        }
        ...
        VaultManager.giveMoney(player,Double.parseDouble(money));
