...
public class VaultHasFunction extends NormalFunction {
    @Override
    public FunctionResult whenFunctionCalled(SpellContext spellContext, List<FunctionResult> args) {
        if (args.size()<2) {
            return new ErrorResult("INSUFFICIENT_ARGUMENTS", "VaultHas function requires at least two arguments.");
        }
        ...
        return new BooleanResult(VaultManager.hasMoney(player,Double.parseDouble(money)));
    }
