...
public class FoliaTimerFunction extends NormalFunction {
    @Override
    public FunctionResult whenFunctionCalled(SpellContext spellContext, List<FunctionResult> args) {
        ...
        if(arg1 instanceof StringResult && arg2 instanceof StringResult && arg3 instanceof StringResult && arg4 instanceof ContextMapResult) {
            ...
            MagicTimerManager.registerFoliaTimer(id, Integer.parseInt(delay), Integer.parseInt(period), contextMap);
